import { AfterContentChecked, AfterViewInit, Component, ElementRef, EventEmitter, Input, OnInit, Output, TemplateRef, ViewChild } from '@angular/core';
import { getContentEditableCaretCoords } from 'src/app/autocomplete-utils';
...
export class AutocompleteListComponent implements AfterContentChecked   {
